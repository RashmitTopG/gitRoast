...
app.get("/leetcode/:username", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { username } = req.params;
        const response = yield axios_1.default.get(`https://alfa-leetcode-api.onrender.com/${username}`);
        ...
        const roast = yield (0, gemini_1.generateRoast)(prompt);
        res.send(roast);
    }
    catch (error) {
